...
DATABASES = {
    'default': {
        ...
        'NAME': 'v1.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(JUST_HERE,'static/upload/').replace('\\','/'),
...
SECRET_KEY = 'tp#y+npya$+u&ofzt5)lmd)sx*2d%@b(pq996c-9glgdibxdyl'
